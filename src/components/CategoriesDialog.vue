<template>
    <v-card class="pa-4">
        ...
        <v-row no-gutters>
            <v-col class="overflow-y-auto" style="max-height: 500px;">
                <v-form id="transaction-form" @submit="saveCategories">
                    <v-row v-for="(category, i) in store.categories" :key="i" no-gutters class="my-2">
